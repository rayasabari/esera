            ...
            <div class="kt-footer__wrapper">
                <div class="kt-footer__logo">
                    <a class="kt-header__brand-logo" href="?page=index&amp;demo=demo2">
                        <img alt="Logo" src="assets/media/logos/sra-logo.gif" height="37" class="kt-header__brand-logo-sticky">
                    </a>
                    <div class="kt-footer__copyright">
                        {{ date('Y') }}&nbsp;&copy;&nbsp;
                        <a href="http://keenthemes.com/metronic" target="_blank">PT Speed Reliance Auction</a> - All right reserved
                    </div>
                </div>
