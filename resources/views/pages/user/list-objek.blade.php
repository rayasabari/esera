                ...
                <div class="kt-widget kt-widget--user-profile-3">
                    <div class="kt-widget__top">
                        <div class="kt-widget__media kt-hidden-">
                            <img src="{{ $obj->objek_properti->img }}" alt="image">
                        </div>
                        <div class="kt-widget__content">
                            ...
                            <div class="kt-widget__subhead">
                                <a href="#"><i class="flaticon2-location"></i>{{ $obj->objek_properti->provinsi->text_proper }}</a>
                        ...
                        <div class="kt-widget__item col-lg-3">
                            ...
                            <div class="kt-widget__details">
                                ...
                                @if(isset($obj->last_bid))
                                    <span class="kt-widget__value text-warning">Rp {{ number_format($obj->last_bid->jumlah_bid,0,',','.') }}</span>
                                @else 
