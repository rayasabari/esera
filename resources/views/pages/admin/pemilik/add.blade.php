    ...
    <div class="kt-container">
        <div class="kt-portlet kt-portlet--tab">
            ...
            <div class="kt-portlet__body">
                <form method="post" action="/add/pemilik">
                    @csrf
                    <div class="row" style="background: " style="height: auto">
                        <div class="col-lg-6">
                            <div class="form-group row">
                                <label class="col-xl-4 col-lg-4 col-form-label">Nama Depan <span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-6">
                                    <input name="first_name" class="form-control @error('first_name') is-invalid @enderror" type="text" value="{{ old('first_name') }}">
                                    @error('first_name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <input name="last_name" class="form-control @error('last_name') is-invalid @enderror" type="text" value="{{ old('last_name') }}">
                                    @error('last_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" placeholder="nama jalan" rows="3">{{ Request::segment(1)=='edit' ? old('alamat', $withdata['alamat'])  : old('alamat') }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-8">
                                    <div class="input-group">
                                        ...
                                        <input name="no_telepon" class="form-control @error('no_telepon') is-invalid @enderror" type="text" value="{{ old('no_telepon') }}">
                                            @error('no_telepon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group row">
                                <label class="col-xl-4 col-lg-4 col-form-label">No. Fax <span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-8">
                                    <div class="input-group">
                                        <div class="input-group-prepend"><span class="input-group-text"><i class="la la-fax"></i></span></div>
                                        <input name="no_fax" class="form-control @error('no_fax') is-invalid @enderror" type="text" value="{{ old('no_fax') }}">
                                        @error('no_fax')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-8">
                                    <input name="no_ktp" class="form-control @error('no_ktp') is-invalid @enderror" type="text" value="{{ old('no_ktp') }}">
                                    @error('no_ktp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-xl-4 col-lg-4 col-form-label">NPWP <span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-8">
                                    <input name="npwp" class="form-control @error('npwp') is-invalid @enderror" type="text" value="{{ old('npwp') }}">
                                    @error('npwp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-8">
                                    <input name="nama_bank" class="form-control @error('nama_bank') is-invalid @enderror" type="text" value="{{ old('nama_bank') }}">
                                    @error('nama_bank')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-xl-4 col-lg-4 col-form-label">Cabang Bank<span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-8">
                                    <input name="cabang_bank" class="form-control @error('cabang_bank') is-invalid @enderror" type="text" value="{{ old('cabang_bank') }}">
                                    @error('cabang_bank')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-8">
                                    <input name="atas_nama_bank" class="form-control @error('atas_nama_bank') is-invalid @enderror" type="text" value="{{ old('atas_nama_bank') }}">
